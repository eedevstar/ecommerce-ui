...
export const ShoppingCart = () => {
  ...
  return (
    <>
      ...
      {
        open && (
          <Box position="absolute" top={90} right={-10} width={443} sx={{ border: `4px solid ${alpha(theme.palette.primary.main, 0.12)}`, backgroundColor: 'white', padding: '67px 24px 22px'}}>
            ...
            <Button variant="outlined" sx={{width: "100%"}} onClick={()=>handleClear()}>CLEAR</Button>
          </Box>
        )
      }
    </>
